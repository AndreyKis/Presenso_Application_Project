...
public class MatrixHelper {
    ...
    public static Matrix collectMatrix(Matrix a11, Matrix a12, Matrix a21, Matrix a22) {
        ...
        for (int i = 0; i < rowLength; i++) {
            a11.fillMatrixFromColumnByIndex(i, 0, result[i], 0, rowLength);
            a11.fillMatrixFromColumnByIndex(i, 0, result[i], 0, rowLength);
            a11.fillMatrixFromColumnByIndex(i, 0, result[i + rowLength], 0, rowLength);
            a11.fillMatrixFromColumnByIndex(i, 0, result[i + rowLength], rowLength, rowLength);
        }
